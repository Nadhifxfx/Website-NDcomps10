...
--------------------------------------------------------- */
export async function getLatestVideos(maxResults = 50, pageToken = '', videoDuration = 'any') {
  try {
...
--------------------------------------------------------- */
export async function getPopularVideos(maxResults = 50, pageToken = '', videoDuration = 'any') {
  try {
